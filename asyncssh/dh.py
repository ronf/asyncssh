...
class _KexDHGex(_KexDHBase):
    ...
    def __init__(self, alg, conn, hash_alg, preferred_size=None):
        super().__init__(alg, conn, hash_alg)
    ...
    def _send_request(self):
        ...
        if self._preferred_size:
            ...
            request = (Byte(MSG_KEX_DH_GEX_REQUEST_OLD) +
                       UInt32(self._preferred_size))
        else:
            request = (Byte(self._request_type) +
    ...
    def _process_request(self, pkttype, packet):
        ...
        if preferred_size <= 1024:
            g, p = _group1_g, _group1_p
        else:
            g, p = _group14_g, _group14_p
